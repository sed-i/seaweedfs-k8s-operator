        ...
        layer = Layer(
            {
                ...
                "services": {
                    self.container_name: {
                        ...
                        "command": f"/usr/bin/weed server -dir={self._storage_path} -s3 -s3.config={self._config_path} -ip.bind=0.0.0.0 -master.electionTimeout 1s -master.volumeSizeLimitMB=1024",
                        "startup": "enabled",
                        "environment": {
